// EXERCICIO 4
// Página 41 do livro lógica de programação e Algoritmos com JavaScript de Edécio Iepsen
...
// console.log('Valor do jantar: R$' + valorJantar + ',00'); OPÇÃO #1
console.log(`Valor do jantar: R$${valorJantar},00`); // OPÇÃO #2
